...
{
    'name': 'Payroll: Driving Record Res Partner, Contacts',
    'version': '14.0.0.0.0',
    ...
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-payroll/payroll_driving_record_res_partner',
    ...
    'depends': ['payroll_driving_record', 'contacts'],
